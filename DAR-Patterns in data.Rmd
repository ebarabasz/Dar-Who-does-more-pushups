...
I am going to use the graphical method of a violin plot. I am also going to use the box-whisker plot. 
...
```
The minimum amount of pushups done my a lineman is 6 and 18 by a skilled player. The median amount of pushups done by the lineman was 17 pushups and by the skilled it was about 50. The most pushups done by a lineman was 34 and 108 pushups by a skilled player. 
# Inferential Results
...
```
the p-value was so low that we conclude that  we reject the null and therefore they dont have the same means, they have a different average in total pushups done by position. 
...
In our study we concluded that skilled player can do more pushups then lineman. We got our reults from using a box plot, a violin chart and lastly by using a t test. 
